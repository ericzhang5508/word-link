...
public class AppDbContext : DbContext
{
    ...
    private void SeedData(ModelBuilder modelBuilder)
    {
        ...
        var clues = new List<Clue>
        {
            ...
            new() { Id = 4, PuzzleId = 1, Number = 8, Direction = "Across", Text = "Type of cold-brew coffee or a gas.", Answer = "NITRO", StartRow = 3, StartCol = 0 },
            new() { Id = 5, PuzzleId = 1, Number = 9, Direction = "Across", Text = "Passages in a book (archaic).", Answer = "EYRES", StartRow = 4, StartCol = 0 },
